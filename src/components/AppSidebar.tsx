    ...
    <aside className="hidden lg:flex flex-col w-56 xl:w-60 shrink-0 sticky top-0 h-screen border-r border-gray-100 bg-white overflow-y-auto z-30">
      ...
      <div className="px-4 mt-3">
        <button
          ...
          className="flex items-center gap-2 w-full px-3 py-2 rounded-xl text-[13px] text-gray-400 hover:text-gray-700 hover:bg-gray-50 transition-all"
        >
          <svg
          ...
          <span>{expanded ? t('접기', 'Less', 'Moins') : t('더 보기', 'More', 'Plus')}</span>
        </button>
      </div>
      ...
      >
        <div style={{ overflow: 'hidden' }}>
          <div>
            <div className="mx-5 mt-3 mb-0 border-t border-gray-100" />

            {/* Quick boards */}
            <div className="px-3 pt-3">
              <p className="text-[11px] font-semibold tracking-[0.18em] text-gray-300 uppercase px-3 mb-1.5">
                ...
                {CATS.map(c => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-[13px] text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all text-left"
                    >
            ...
            <div className="px-3 space-y-0.5">
              ...
              <a
                ...
                className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all"
              >
      ...
      {/* City times — always visible at bottom */}
