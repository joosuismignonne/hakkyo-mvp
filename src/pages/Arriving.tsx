...
const JOURNEY_MESSAGES: Array<{ min: number; max: number } & Tri> = [
  {
    min: 0, max: 0,
    ko: '몬트리올은 아직 지도 위의 한 점입니다. 곧 당신의 도시가 될 곳입니다.',
    en: "Montréal is still just a dot on the map. Soon it will be your city.",
    fr: "Montréal n'est encore qu'un point sur la carte. Bientôt, ce sera votre ville.",
  },
  {
    min: 1, max: 24,
    ko: '첫 발걸음을 내디뎠습니다. 한 걸음씩, 몬트리올에 가까워지고 있습니다.',
    en: "You've taken your first step. One by one, Montréal is getting closer.",
    fr: "Vous avez fait votre premier pas. Pas à pas, Montréal se rapproche.",
  },
  {
    min: 25, max: 49,
    ko: '한 걸음씩, 몬트리올에 가까워지고 있습니다.',
    en: "Step by step, you're getting closer.",
    fr: "Pas à pas, vous vous rapprochez.",
  },
  {
    min: 50, max: 74,
    ko: '절반을 지나왔습니다. 이제 몬트리올이 조금씩 익숙해질 겁니다.',
    en: "Past halfway. Montréal is starting to feel familiar.",
    fr: "Passé la moitié. Montréal commence à vous sembler familière.",
  },
  {
    min: 75, max: 99,
    ko: '거의 다 됐습니다. 이제 몬트리올이 집처럼 느껴질 겁니다.',
