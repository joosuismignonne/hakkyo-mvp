...
export const MOCK_QUESTIONS: FormQuestion[] = [
  {
    ...
    type: 'text', required: true, order_index: 1, session_id: null,
  },
  {
    id: 'Q2',
    ...
    required: true, order_index: 2, session_id: null,
  },
  {
    id: 'Q3',
