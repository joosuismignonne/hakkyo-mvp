...
export const MOCK_QUESTIONS: FormQuestion[] = [
  {
    ...
    type: 'text', required: true, track_id: null, order_index: 1, session_id: null, question_tags: [],
  },
  {
    id: 'Q2',
    ...
    required: true, track_id: null, order_index: 2, session_id: null, question_tags: [],
  },
  {
    id: 'Q3',
    ...
    required: false, track_id: null, order_index: 3, session_id: null, question_tags: [],
  },
  {
    id: 'Q4',
    question_ko: '참여 목표를 알려주세요.', question_en: 'What is your main goal for joining?',
    question_fr: 'Quel est votre principal objectif?',
    type: 'textarea', required: false, track_id: null, order_index: 4, session_id: null, question_tags: [],
  },
]
