...
export const UI = {
  ko: {
    ...
    home: {
      ...
      ctaTitle: '4기 모집은 10월 — 지금 소식 신청하면 가장 먼저 알려드려요',
      wednesday: '수요일',
    },
  ...
  en: {
    ...
    home: {
      ...
      ctaTitle: 'Session 4 in October — subscribe now to be notified first',
      wednesday: 'Wednesday',
    },
  ...
  fr: {
    ...
    home: {
      ...
      ctaTitle: 'Session 4 en octobre — abonnez-vous pour être notifié en premier',
      wednesday: 'Mercredi',
    },
    ...
    channels: {
      board: 'Annonces',
      chat: 'Général',
      exchange: 'Échange de langues',
      housing: 'Logement',
      jobs: 'Emploi & Immigration',
      events: 'Événements',
      reviews: 'Avis',
    },
    reviews: {
